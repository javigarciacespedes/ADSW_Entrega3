...
public class PruebaVehiculo {
	...
	public void testE1() throws Exception{
		Vector destino = new Vector(30.0,0.0);
		Vehiculo Renault = new Vehiculo("Renault", new Vector(0.0, 0.0),0.0, new Vector(100.0, 100.0),10.0); 
		Renault.arrancaVehiculo(destino,1);
		assertEquals(new Vector(30.0,0.0),Renault.getPos());
	...
	public void testE2(){
		...
		Vehiculo Renault = new Vehiculo("Renault", new Vector(0.0, 0.0),0.0, new Vector(100.0, 100.0),10.0); 
		try {
			Renault.arrancaVehiculo(destino,2);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		assertEquals(new Vector(0.0,0.0),Renault.getPos());
	}
